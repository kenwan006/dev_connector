...
router.put('/like/:id', auth, async (req, res) => {
    try {
      ...
      post.likes.unshift({ user: req.user.id }); // add the current user to the like list of this post
...
// @desc    Delete commnet (delete the commnet with comment_id from the post with id)
// @access  Private
